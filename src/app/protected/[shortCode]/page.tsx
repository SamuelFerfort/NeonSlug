        ...
        <CardContent>
          <form action={verifyPasswordAction} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isPending}
              className={`w-full py-2.5 px-4 text-sm font-medium rounded-md text-white bg-pink-600 hover:bg-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors relative overflow-hidden ${
                isPending ? "bg-pink-500/90" : ""
              }`}
            >
              {isPending ? (
                <>
