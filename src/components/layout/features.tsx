    ...
    <section className="w-full max-w-4xl mx-auto animate-in fade-in-0 slide-in-from-bottom-4 duration-300 ">
        ...
        <div className="flex justify-center gap-4">
          <Link href="/login">
            <Button
              ...
              className="border-neon-pink text-neon-pink bg-transparent hover:bg-neon-pink/10 hover:text-neon-pink-glow hover:scale-105 hover:shadow-[0_0_15px_rgba(255,16,240,0.15)] flex items-center gap-2 w-full sm:w-auto"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 z-100">
        {features.map((feature, index) => (
          <Card
            key={index}
            className="bg-gray-900/80 backdrop-blur-sm border-gray-800 hover:border-neon-pink hover:bg-gray-900/90 transition-all duration-200 hover:shadow-[0_0_25px_rgba(255,16,240,0.15)] hover:-translate-y-1 hover:scale-[1.02] group"
          >
